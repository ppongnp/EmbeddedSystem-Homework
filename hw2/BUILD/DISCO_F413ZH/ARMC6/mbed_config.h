...
#define CLOCK_SOURCE                                                          USE_PLL_HSE_EXTC|USE_PLL_HSI                                                                     // set by target:DISCO_F413ZH
#define LPTICKER_DELAY_TICKS                                                  4                                                                                                // set by target:DISCO_F413ZH
#define MBED_CONF_APP_WIFI_PASSWORD                                           "ic_kmitl"                                                                                       // set by application
#define MBED_CONF_APP_WIFI_SHIELD                                             WIFI_ISM43362                                                                                    // set by application
#define MBED_CONF_APP_WIFI_SSID                                               "IC_wifi"                                                                                        // set by application
...
#define MBED_CONF_TARGET_LPTICKER_LPTIM                                       1                                                                                                // set by target:DISCO_F413ZH
